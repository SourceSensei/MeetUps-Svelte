...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$5, 33, 4, 479);
    			attr_dev(header, "class", "svelte-5bqq35");
    			add_location(header, file$5, 32, 0, 465);
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "svelte-1wrtsh2");
    			add_location(button, file$4, 10, 0, 147);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p1, file$3, 79, 4, 1143);
    			attr_dev(div1, "class", "content svelte-enhpap");
    			add_location(div1, file$3, 78, 2, 1117);
    			attr_dev(footer, "class", "svelte-enhpap");
    			add_location(footer, file$3, 81, 2, 1175);
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*controllType*/ ctx[0] === "textarea") return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label_1, file$1, 10, 2, 181);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (controllType === undefined && !('controllType' in $$props || $$self.$$.bound[$$self.$$.props['controllType']])) {
    			console.warn("<TextInput> was created without expected prop 'controllType'");
    		}
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file, 55, 2, 1550);
    			attr_dev(main, "class", "svelte-14fgpj0");
    			add_location(main, file, 54, 0, 1541);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
