...
var app = (function () {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-5bqq35");
    			add_location(h1, file$8, 33, 4, 479);
    			attr_dev(header, "class", "svelte-5bqq35");
    			add_location(header, file$8, 32, 0, 465);
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "color", /*color*/ ctx[3]);
    ...
    // (37:4) <Button       mode="outline"       color={isFav ? null : "success"}       type="button"       on:click={() => dispatch("togglefavorite", id)}       >
    function create_default_slot_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(37:4) <Button       mode=\\\"outline\\\"       color={isFav ? null : \\\"success\\\"}       type=\\\"button\\\"       on:click={() => dispatch(\\\"togglefavorite\\\", id)}       >",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$5, 25, 4, 495);
    			attr_dev(p0, "class", "svelte-enhpap");
    			add_location(p0, file$5, 26, 4, 519);
    			attr_dev(header, "class", "svelte-enhpap");
    			add_location(header, file$5, 18, 2, 387);
    			...
    			add_location(img, file$5, 29, 4, 574);
    			attr_dev(div0, "class", "image svelte-enhpap");
    			add_location(div0, file$5, 28, 2, 550);
    			attr_dev(p1, "class", "svelte-enhpap");
    			add_location(p1, file$5, 32, 4, 646);
    			attr_dev(div1, "class", "content svelte-enhpap");
    			add_location(div1, file$5, 31, 2, 620);
    			attr_dev(footer, "class", "svelte-enhpap");
    			add_location(footer, file$5, 34, 2, 678);
    			attr_dev(article, "class", "svelte-enhpap");
    			add_location(article, file$5, 17, 0, 375);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$3, 14, 4, 336);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$3, 12, 4, 278);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(12:2) {#if controllType === \\\"textarea\\\"}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*controllType*/ ctx[0] === "textarea") return create_if_block$1;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label_1, file$3, 10, 2, 204);
    			attr_dev(div, "class", "form-control svelte-xzzzlr");
    			add_location(div, file$3, 9, 0, 174);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['controllType', 'id', 'label', 'rows', 'value', 'type'];
    	...
    	$$self.$$set = $$props => {
    		if ('controllType' in $$props) $$invalidate(0, controllType = $$props.controllType);
    	...
    	return [controllType, id, label, rows, value, type, input_handler, input_handler_1];
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "modal-backdrop svelte-ixvgdn");
    			add_location(div0, file$2, 16, 0, 251);
    			attr_dev(h1, "class", "svelte-ixvgdn");
    			add_location(h1, file$2, 18, 2, 328);
    			attr_dev(div1, "class", "content svelte-ixvgdn");
    			add_location(div1, file$2, 19, 2, 348);
    			attr_dev(footer, "class", "svelte-ixvgdn");
    			add_location(footer, file$2, 22, 2, 397);
    			attr_dev(div2, "class", "modal svelte-ixvgdn");
    			add_location(div2, file$2, 17, 0, 305);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file$1, 39, 2, 668);
    		},
    		m: function mount(target, anchor) {
    ...
    // (81:4) <Button type="button" mode="outline" on:click={cancel}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(81:4) <Button type=\\\"button\\\" mode=\\\"outline\\\" on:click={cancel}>",
    		ctx
    	});
    ...
    // (82:4) <Button type="button" on:click={submitForm}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(82:4) <Button type=\\\"button\\\" on:click={submitForm}>",
    		ctx
    	});
    ...
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 79, 2, 1688);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    // (73:4) <Button on:click={() => (editMode = "add")} >
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(73:4) <Button on:click={() => (editMode = \\\"add\\\")} >",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 71, 2, 2086);
    			attr_dev(main, "class", "svelte-1w77hyv");
    			add_location(main, file, 70, 0, 2077);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    	...
    	let meetups = [
    		{
    			...
    			imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Caffe_Nero_coffee_bar.jpg/1024px-Caffe_Nero_coffee_bar.jpg",
    		...
    		},
    		{
    			...
    			imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Aquarium_in_Boston%2C_Massachusetts%2C_1870.jpg/800px-Aquarium_in_Boston%2C_Massachusetts%2C_1870.jpg",
    			address: "27th Nerd Road, 32523 New York",
    			contactEmail: "l7Y1R@example.com",
    			isFavorite: false
    		}
